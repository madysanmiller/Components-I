...
function articleMaker (artObj) {
  ...
  articleParagraph1.textContent = artObj.firstParagraph;
  articleParagraph2.textContent = artObj.secondParagraph;
  articleParagraph3.textContent = artObj.thirdParagraph;
